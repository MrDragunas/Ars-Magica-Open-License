...
collectively as Mythic Companions. While Hermetic magi are normally still the most potent characters in terms of raw power, Mythic Companions approach them. However, as they are not members of the Order of Hermes, they cannot play the same social role in a saga as a magus.
...
Equipment: Pole Axe, Full metal scale armor, pack containing gear to care for weapons and armor and establish camps when traveling.
...
Virtues and Flaws: Covenfolk, Warrior, Weakness (talking back to magi)
...
Virtues and Flaws: Covenfolk, Warrior, Pessimistic Personality Traits: Brave +3, Loyal +1, Pessimistic +3
...
Abilities: Area Lore 4 (game trails), Athletics 1 (climbing), Awareness 5 (woodlands), Bows 4 (shooting from cover), Hunt 5 (deer), Native Language 5 (talking about forests), Stealth 2 (hunting), Survival 4 (woodlands)
...
Abilities: Area Lore 3 (taverns), Athletics 3 (running), Awareness 3 (in combat), Bows 4 (short bow), Brawl 4 (punching), Carouse 3 (drinking), Charm 2 (opposite sex), Etiquette 2 (magi), Great Weapon 4 (pole axe), Guile 2 (avoiding duties), Native Language 5 (rude words), Single Weapon 5 (heater shield), Survival 1 (for a short period)
...
Virtues and Flaws: The Gift, Hermetic Magus, Ways of

the Forest; Heartbeast\*, Inoffensive to Animals, Quiet
...
The troupe or storyguide should make a decision

on starting ages, bearing these factors in mind. There are a few guidelines worth following, however. First, new players should create magi who

are just out of apprenticeship. Magi have a lot of choices, and until you have played the game a bit you won't know which choices suit your playing style.
...
- Grogs: Take a Minor Personality Flaw that reflects how you want to play the character. Social Status is Covenfolk.
   Take Warrior for a grog who fights, Educated for a grog who is educated, Arcane Lore for a grog who knows about the supernatural, and Puissant Ability in the character's specialty for any other type of character.
